...
<head>
<title>call</title>
<body background="images/team.jpg">

  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="40%">
      <tr><td><center><font size="+5" color="GREEN">TeamInfo</center></td>
      </tr>
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        <TD><font color="green"></b><center> teamid</center></td>
        <td><font color="green"></b><center>dept</center></td>
        <td><font color="green"></b><center>teamLeadername</center></td>
        <TD><font color="green"></b><center>totalEmpInTeam</center></td>
