...
<head>
<title>call</title>
<body background="images/ppppppp.png">

  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="40%">
      <tr><td><center><font size="+5" color="GREEN">EmployeeInfo</center></td>
      </tr>
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        ...
        <td><font color="green"></b><center>companyname</center></td>
   ...
   <td><font  color="green"></b><center>experience</center></td>
