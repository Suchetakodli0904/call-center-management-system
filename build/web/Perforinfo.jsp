...
<head>
<title>call</title>
<body background="images/call-center-agent-customer-service-adviser-hotline.jpg">

  <table  border="2"  cellpadding="2" cellspacing="0" bgcolor="skyblue" width="40%">
      <tr><td><center><font size="+5" color="GREEN">PerformenceInfo</center></td>
      </tr>
...
<table bordercolor="black" border="5"  bgcolor="lightyellow"  cellpadding="0"
    ...
    <TR>
        <TD><font color="green"></b><center>performenceid</center></td>
        <td><font color="green"></b><center>empid</center></td>
        <td><font color="green"></b><center>name</center></td>
   ...
   <td><font  color="green"></b><center>CustomerRating</center></td>
